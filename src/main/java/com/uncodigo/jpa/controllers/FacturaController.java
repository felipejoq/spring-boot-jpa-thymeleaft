...
import com.uncodigo.jpa.models.entity.ItemFactura;
...
public class FacturaController {
	...
	public String ver(@PathVariable(value="id") Long id,
		...
		Factura factura = this.clienteService.fetchByIdWithClienteWithItemFacturaWithProducto(id); //clienteService.findFacturaById(id);
